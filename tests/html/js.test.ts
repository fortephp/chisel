// Auto-generated from Prettier HTML snapshot: js/
...
`;
  ...
  it("something-else.html", async () => {
    const input = `<script type="text/template">
 <div>
    </div>
</script>
`;
    const expected = `<script type="text/template">
  <div>
     </div>
</script>
`;
  ...
  it("template-literal.html", async () => {
    const input = `<!DOCTYPE html>
<html lang="en">
    <head>
    </head>
...
`;
  ...
  it("typescript.html", async () => {
    const input = `<script type="application/x-typescript">
  class Student {
    fullName: string;
...
`;
    const expected = `<script type="application/x-typescript">
  class Student {
    fullName: string;
    constructor(
