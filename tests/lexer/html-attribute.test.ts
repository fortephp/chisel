...
describe("HTML Attributes", () => {
  ...
  test("input tag full", () => {
    const source =
      '<input type="text" name="username" id="user-input" class="form-control" placeholder="Enter username" required maxlength=50>';
    const result = tokenize(source);
  ...
  test("ten attributes", () => {
    const source =
      '<div a1="v1" a2="v2" a3="v3" a4="v4" a5="v5" a6="v6" a7="v7" a8="v8" a9="v9" a10="v10">';
    const result = tokenize(source);
  ...
  test("long attribute value", () => {
    const source =
      '<div data="This is a very long attribute value that contains many words and special characters like <>&\\"">';
    const result = tokenize(source);
